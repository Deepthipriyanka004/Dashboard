...
const CreateTestPage = () => {
  ...
  return (
    <div className="flex-1 overflow-auto relative z-10 bg-gray-900">
      ...
      <main className="max-w-7xl mx-auto py-10 px-4 lg:px-8 grid gap-6 md:grid-cols-2">
        <div
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Design and assign coding assessments.</p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">Create and manage multiple choice questions.</p>
          </div>
        </div>
      </main>
    </div>
